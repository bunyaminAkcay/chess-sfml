...
Rook::Rook(Color color, Board* boardPointer) {
	...
	if (this->color == Color::Black) {
		fileName = "assets/b_rook_png_128px.png";
	}
	if (this->color == Color::White) {
		fileName = "assets/w_rook_png_128px.png";
	}
...
std::list<sf::Vector2u> Rook::getMoves(sf::Vector2u position) {
